	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="faq-wrap">
					<h4 class="mb-20">Accordion Exemplo</h4>
					<div id="accordion">
						<div class="card">
							<div class="card-header">
								<button class="btn btn-block" data-toggle="collapse" data-target="#faq1">
									Perguntas Frequentes Grupo Item #1
								</button>
							</div>
						...
						<div class="card">
							<div class="card-header">
								<button class="btn btn-block collapsed" data-toggle="collapse" data-target="#faq2">
									Perguntas Frequentes Grupo Item #2
								</button>
							</div>
						...
						<div class="card">
							<div class="card-header">
								<button class="btn btn-block collapsed" data-toggle="collapse" data-target="#faq3">
									Perguntas Frequentes Grupo Item #3
								</button>
							</div>
						...
						<div class="card">
							<div class="card-header">
								<button class="btn btn-block collapsed" data-toggle="collapse" data-target="#faq4">
									Perguntas Frequentes Grupo Item #4
								</button>
							</div>
						...
						<div class="card">
							<div class="card-header">
								<button class="btn btn-block collapsed" data-toggle="collapse" data-target="#faq5">
									Perguntas Frequentes Grupo Item #5
								</button>
							</div>
						...
						<div class="card">
							<div class="card-header">
								<button class="btn btn-block collapsed" data-toggle="collapse" data-target="#faq6">
									Perguntas Frequentes Grupo Item #6
								</button>
							</div>
					...
					<h4 class="mb-30 padding-top-30">Collapse Exemplo</h4>
