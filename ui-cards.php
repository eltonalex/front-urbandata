		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="row clearfix">
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="card box-shadow">
							<img class="card-img-top" src="vendor/images/img2.jpg" alt="Card image cap">
							<div class="card-body">
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="card box-shadow">
							<img class="card-img-top" src="vendor/images/img3.jpg" alt="Card image cap">
							<div class="card-body">
								<h5 class="card-title weight-500">Card title</h5>
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="card box-shadow">
							...
							<img class="card-img-top" src="vendor/images/img1.jpg" alt="Card image cap">
							<div class="card-body">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="card box-shadow">
							<img class="card-img-top" src="vendor/images/img4.jpg" alt="Card image cap">
							<div class="card-body">
				...
				<div class="row clearfix">
					...
					<div class="col-sm-12 col-md-12 col-lg-4 mb-30">
						<div class="card bg-dark box-shadow">
							<img class="card-img" src="vendor/images/img1.jpg" alt="Card image">
					...
					<div class="col-sm-12 col-md-12 col-lg-4 mb-30">
						<div class="card box-shadow">
							...
							<img class="card-img-bottom" src="vendor/images/img5.jpg" alt="Card image cap">
						</div>
					</div>
				</div>
				<div class="row clearfix">
				...
				<div class="card-columns mb-30">
					...
					<div class="card">
						<img class="card-img" src="vendor/images/img3.jpg" alt="Card image">
					</div>
