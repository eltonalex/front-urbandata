...
;(function(factory) {
    ...
    (function() {
        ...
        for(var x = 0; x < vendor.length && !window.requestAnimationFrame; ++x) {
            window.requestAnimationFrame = window[vendor[x]+'RequestAnimationFrame'];
            window.cancelAnimationFrame = window[vendor[x]+'CancelAnimationFrame']
                || window[vendor[x]+'CancelRequestAnimationFrame'];
        }
