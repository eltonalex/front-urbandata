							...
							<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img class="d-block w-100" src="vendor/images/img2.jpg" alt="First slide">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="vendor/images/img3.jpg" alt="Second slide">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="vendor/images/img4.jpg" alt="Third slide">
									</div>
								</div>
							</div>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 mb-30">
						<div class="bg-white border-radius-4 box-shadow mb-30">
							...
							<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img class="d-block w-100" src="vendor/images/img3.jpg" alt="First slide">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="vendor/images/img4.jpg" alt="Second slide">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100" src="vendor/images/img5.jpg" alt="Third slide">
									</div>
								</div>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 mb-30">
						<div class="bg-white border-radius-4 box-shadow mb-30">
							...
							<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img class="d-block w-100" src="vendor/images/img1.jpg" alt="First slide" />
									...
									<div class="carousel-item">
										<img class="d-block w-100" src="vendor/images/img2.jpg" alt="Third slide" />
										<div class="carousel-caption d-none d-md-block">
